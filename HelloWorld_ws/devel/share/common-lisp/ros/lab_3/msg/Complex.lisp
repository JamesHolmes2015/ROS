...
(cl:defmethod cl:initialize-instance :after ((m <Complex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Complex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab_3-msg:<Complex> is deprecated: use lab_3-msg:Complex instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab_3-msg:real-val is deprecated.  Use lab_3-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab_3-msg:imaginary-val is deprecated.  Use lab_3-msg:imaginary instead.")
  (imaginary m))
